...
def save_img(font_name):
    ttf = u'/Users/weifei/Documents/workspace/pywork/jtfont/' + font_name + '.ttf'
    print(ttf)
    im = Image.open('/Users/weifei/Documents/workspace/pywork/jtfont/1.jpg')
    ...
    im.save("/Users/weifei/Documents/workspace/pywork/jtfont/"+font_name + ".jpg", 'JPEG', quality=100)
...
def main2():
    path = "/Users/weifei/Documents/workspace/pywork/jtfont/"
    files = os.listdir(path)
    for f in files:
